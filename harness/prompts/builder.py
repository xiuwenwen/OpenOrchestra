    ...
    def _phase_specific_rules(self, context: AgentRunContext) -> list[str]:
            ...
            if context.phase == "PLANNING_REVISION":
                ...
                return [
                    ...
                    *plan_recheck_rules,
                    ...
                    "- If a reviewer `review_result.json` from PLAN_REVIEW is present with `review_decision_code: 1` or `review_decision_code: -1`, treat it as the authoritative revision request and revise only against that feedback.",
        ...
        if context.role == "reviewer":
            ...
            return [
                ...
                "- In `review_result.json`, use `review_decision_code: 0` for approved, `1` for changes required, or `-1` for blocking rejection.",
